...
class DeleteApi<T> with HandlingRequestException {
  final Uri uri;
  final FromJson fromJson;
  DeleteApi({required this.uri, required this.fromJson});
  Future<T> callRequest() async {
    try {
      ...
      log('http exception', name: 'RequestManager get function');
      rethrow;
    } on FormatException {
      log(
      ...
      log('socket exception', name: 'RequestManager get function');
      rethrow;
    } catch (e) {
      log(e.toString(), name: 'RequestManager get function');
      rethrow;
    }
  }
}
